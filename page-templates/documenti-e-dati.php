	...
	<main>
		<?php
			while ( have_posts() ) :
				...
				get_template_part("template-parts/documento/evidenza");
				get_template_part("template-parts/documento/tutti-documenti");
				get_template_part("template-parts/documento/categorie");
