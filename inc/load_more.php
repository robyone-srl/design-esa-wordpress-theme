...
function dci_sanitize_load_more_post_types($post_types) {
    $allowed = array('post', 'page', 'categoria_servizio', 'documento_pubblico', 'dataset', 'domanda-frequente', 'incarico', 'persona_pubblica', 'notizia', 'evento', 'servizio', 'unita-organizzativa', 'luogo', 'contatto');
