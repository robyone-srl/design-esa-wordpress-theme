<?php
global $posts, $the_query, $load_posts, $procedura, $load_card_type, $should_have_grey_background, $found_posts, $order_values, $post_type_multiple;
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-9">
                        <div id="tutte-procedure" class="<?= !($should_have_grey_background=(!$should_have_grey_background)) ? 'bg-grey-dsk':'' ?>">
                            ...
                            <div class="pb-lg-60 ps-4">
                                <?php 
                                    $found_posts = $the_query->found_posts;
                                    $post_type_multiple = "procedure trovate";
