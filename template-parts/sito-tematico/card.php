...
<a href="<?php echo $st_link ?>" style="<?= ($mostra_sfondo && $colore_sfondo) ? 'background-color:'.$colore_sfondo : '' ?>" class="card card-teaser <?= $mostra_sfondo && !$colore_sfondo ? 'bg-primary' : '' ?> rounded mt-0 p-3 shadow-sm border border-light" target="_blank">
    <?php if($st_img) { ?>
