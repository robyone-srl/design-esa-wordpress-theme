<?php 
global $the_query, $load_posts, $wp_the_query, $load_card_type, $additional_filter, $filter_ids, $label, $label_no_more, $tax_query, $classes, $order_values, $title_level;
...
$query_params = '?post_count='.$the_query->post_count.'&title_level='.$title_level.'&load_posts='.$load_posts.'&search='.$query_search.'&post_types='.$post_types.'&load_card_type='.$load_card_type.'&query_params='.$query_params.'&filter_ids='.$filter_ids.'&tax_query='.$tax_query.'&additional_filter='.$additional_filter.'&order_by='.$order_values["option"];
