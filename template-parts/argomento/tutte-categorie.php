<?php
    global $argomento,$is_set_notizie, $is_set_event, $first_printed;

    $n_eventi = 3;
        
        get_template_part("template-parts/notizia/prossime-notizie");
        get_template_part("template-parts/evento/prossimi-eventi");
        ...
        <div class="container">
            <div class="border-bottom border-2 border-light">
                <div class="row align-items-center pb-2">
                    ...
                    <?php 
                    if($is_set_notizie || $is_set_event){echo "Gli altri contenuti";} else {echo"Tutti i contenuti"; }?>
                    </h3>
    ...
    $('#save-selection').on('click', function() {
        ...
        if (selectedOption.length > 0) {
            ...
            if (!existentButtons.length) {
                var newButtonHtml = `<button type="button" class="btn btn-extra-filter btn-outline-primary btn-sx w-150 mx-1" 
