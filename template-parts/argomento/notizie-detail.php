...
$posts = dci_get_grouped_posts_by_term('novita', 'argomenti', $argomento->slug, -1);
        ...
        <div class="container">
            <div class="border-bottom border-2 border-light">
                ...
                <div class="card-wrapper px-0 card-teaser-wrapper card-teaser-wrapper-equal card-teaser-block-3">
                    <?php foreach ($card_visibili as $post) {
				        ...
				        get_template_part("template-parts/home/notizia-evidenza", "" ,$post);
            ...
            <div class="pagination-container">
                <?php if ($pagine_card_totali > 1): ?>
                    <div class="row mt-4 card-pagination-row" data-card-corrente="<?=$pagina_card_corrente?>" data-card-totali="<?=$pagine_card_totali?>" data-post-type="novita" data-posts-per-page="<?=$card_per_pagina?>">
                        <div class="col-12">
                            <nav>
