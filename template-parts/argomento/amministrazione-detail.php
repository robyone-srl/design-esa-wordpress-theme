...
$posts = dci_get_grouped_posts_by_term('amministrazione', 'argomenti', $argomento->slug, -1);
        ...
        <div class="container">
            ...
            <div class="pagination-container">
                <?php if ($pagine_card_totali > 1): ?>
                    <div class="row mt-4 card-pagination-row" data-card-corrente="<?=$pagina_card_corrente?>" data-card-totali="<?=$pagine_card_totali?>" data-post-type="amministrazione" data-posts-per-page="<?=$card_per_pagina?>">
                        <div class="col-12">
                            <nav>
