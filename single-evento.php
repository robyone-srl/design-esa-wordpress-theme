            ...
            <section class="col-lg-9 it-page-sections-container border-light">
                <article id="cos-e" class="it-page-section mb-5" data-audio>
                    ...
                    <?php if($appuntamenti_genitore != null){ ?>
                        <div id="appuntamenti" class="it-page-section mb-5">
                            <h3 class="h4 mb-3">Evento Genitore</h3>
                    ...
                    <?php if ($video || (is_array($gallery) && count($gallery))) { ?>
                        <div id="media" class="it-page-section mb-5">
                            <h3 class="h4 mb-3">Media</h2>
                    ...
                    <article id="date-e-orari" class="it-page-section mb-5">
                        ...
                        <div class="point-list-wrapper my-4">
                            ...
                            <?php if ($end_timestamp) { ?>
                                <div class="point-list">
                                    <h3 class="h4 point-list-aside point-list-primary fw-normal">
                                        <span class="point-date font-monospace"><?php echo $end_date_arr[0]; ?></span>
                                        <span class="point-month font-monospace"><?php echo $end_date_arr[1]; ?></span>
                                    </h3>
                                    <div class="point-list-content">
                                        <div class="card card-teaser shadow rounded">
                                            <div class="card-body">
                    ...
                    if ((is_array($patrocinato) && count($patrocinato)) ||
                        ...
                        if (is_array($patrocinato) && count($patrocinato)) { ?>
                                ...
                                <div class="link-list-wrapper mb-3">
                                    <ul class="link-list">
                                    <?php foreach ($patrocinato as $item) { ?>
                                        <li>
                                            <a class="list-item px-0" href="<?php echo $item['_dci_evento_url']; ?>" target="_blank">
                                                <span><?php echo $item['_dci_evento_nome']; ?></span>
                                            </a>
                                        </li>
                                    <?php } ?>
                                    </ul>
